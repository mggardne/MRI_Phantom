...
%     spreadsheets, phantoms?_T2star2.xlsx and phantomss?_T2star2.xlsx.
%     ? is the series number.  Vial results are written to
%     phantoms?_T2star2.xlsx and slice results are written to
%     phantomss?_T2star2.xlsx.
%
%          The plots are saved into Postscript files,
%     phantoms?_T2star2.ps.
%
%          The data and results are saved into MAT files,
%     phantoms?_T2star2.mat.
%
%     NOTES:  1.  Matlab MAT files phantoms?_plt2.mat must be in the
%             current directory or path.  ? is the series number.
%
%             2.  M-file exp_fun1.m must be in the current directory or
%             path.
%
%             3.  See phantoms_plt2.m for the segmentations of the
%             vials in the Series.
%
%     20-Aug-2021 * Mack Gardner-Morse
%
...
%
fmats = dir('phantoms*_plt2.mat');
%
if size(fmats,1)<1
  warning([' *** WARNING in phantoms_T2star2:  No segmentation', ...
...
%
   pfile = ['phantoms' snt '_T2star2.ps'];
%
...
%
   xlsfile = ['phantoms' snt '_T2star2.xlsx'];
%
...
%
   xlsfile = ['phantomss' snt '_T2star2.xlsx'];
%
...
%
   matfiles = ['phantoms' snt '_T2star2.mat'];
