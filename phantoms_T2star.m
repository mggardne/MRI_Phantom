%#######################################################################
%
%                   * PHANTOM Star T2STAR Program *
%
%          M-File which reads the MRI phantom data and vial masks
%     to calculate the T2* values in the vials.  For the reduced
%     radii segmentations.  T2* values are calculated for all the
%     pixels in each vial for each slice.  Also all the pixels in each
%     vial for each slice are used to calculate single T2* values for
%     the vials.
%
%          The T2* values and statistics are written to two MS-Excel
%     spreadsheets, phantoms?_T2star.xlsx and phantomss?_T2star.xlsx.
%     ? is the series number.  Vial results are written to
%     phantoms?_T2star.xlsx and slice results are written to
%     phantomss?_T2star.xlsx.
%
%          The data and results are saved into MAT files,
%     phantoms?_T2star.mat.
%
%     NOTES:  1.  Matlab MAT files dicom_lst2.mat and phantoms?_plt.mat
...
%             path.
%
%             3.  See phantoms_plt.m for the segmentations of the
%             vials in the Series.
%
%     28-Jul-2021 * Mack Gardner-Morse
%
...
opt = optimset('Display','off','TolFun',1e-8,'TolX',1e-8, ...
               ...
               'UseParallel',true);
%
T2star0 = [36; 43; 58]; % Initial T2* values (~average values)
idx0 = [1; 3; 2];
...
%
load dicom_lst2.mat etn sn stxt;
...
% Load T2* Masks
%
matfile = ['phantoms' snt '_plt.mat'];
load(matfile,'etxt','istrt','iszs','nfile','nsl','nvial','v','vmsk');
%
...
%
sT2starvcov = 100*sT2starvsd./sT2starvm;
%
...
%
xlsfile = ['phantoms' snt '_T2star.xlsx'];
%
...
%
xlsfile = ['phantomss' snt '_T2star.xlsx'];
%
...
%
matfiles = ['phantoms' snt '_T2star.mat'];
